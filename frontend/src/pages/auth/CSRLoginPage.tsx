      ...
      <div className="lg:hidden min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 pb-12">
          ...
          <div className="w-full max-w-sm">
            ...
            <p className="text-gray-600 text-center mb-8">Login to your CSR account</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" variant="primary" className="w-full bg-blue-500 hover:bg-blue-600" isLoading={isLoading}>
                Sign In
              </Button>
            </form>
          </div>
        ...
        <div className="w-1/2 bg-blue-500 relative overflow-hidden">
          <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-white">
            ...
            <div className="relative z-10 text-center">
              <h2 className="text-4xl font-bold mb-4">CSR Agent</h2>
              <p className="text-xl text-white/90">Manage orders and support customers</p>
            </div>
          </div>
        </div>
