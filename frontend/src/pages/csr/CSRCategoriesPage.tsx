        ...
        <header className="bg-white border-b border-gray-200 px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Organize and manage product categories</p>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 text-sm mt-1">Get started by creating your first category</p>
                <button
                  onClick={() => setShowAddForm(true)}
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-gray-500">ID: {category._id.slice(-8)}</div>
                            </div>
                          </div>
                        </td>
              ...
              <form onSubmit={handleAddCategory} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition"
                  />
                  <p className="text-xs text-gray-500 mt-1">Paste image URL from a hosting service</p>
                </div>
